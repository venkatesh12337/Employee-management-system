...
char username[10],password[10]; //Venkatesh joshi 
printHead();
welcome();
printHead();
printf("\n\t\t\t\t  Login Screen");
...
if(flag==1)
    ...
    fwrite(&e,sizeof(e),1,fp);//Venkatesh joshi 
}
...
if(flag==1)
    ...
    printf("\n\t\tNAME : %s",e.name);
        printf("\n\n\t\tID : %d",e.id);
        printf("\n\n\t\tDESIGNATION : %s",e.desgn);
        printf("\n\n\t\tBRANCH : %s",e.branch);//Venkatesh joshi 
        printf("\n\n\t\tSALARY: %.2f",e.sal);
        printf("\n\n\t\tPRESENT ADDRESS : %s",e.psaddr);
        printf("\n\n\t\tPERMANANT ADDRESS : %s",e.prtaddr);
        printf("\n\n\t\tPHONE : %s",e.phone);
...
{
    printHead();
     printf("\n\t\t\t\List of Employee From Dhaka");//Venkatesh joshi 
    Employee e;
    int i,siz=sizeof(e);
...
void mainbr(FILE * fp)
{
    ...
    while((fread(&e,siz,1,fp))==1)//Venkatesh joshi 
    {
        if((strcmp(e.branch,"Main")==0)||(strcmp(e.prtaddr,"main")==0)||(strcmp(e.prtaddr,"MAIN")==0))
        {
        printf("\n\n\t\tID : %d",e.id);
        printf("\n\n\t\tNAME : %s",e.name);
        printf("\n\n\t\tDESIGNATION : %s",e.desgn);//Venkatesh joshi 
        printf("\n\n\t\tPHONE : %s",e.phone);
        printf("\n\n\t\tE-MAIL : %s\n\t",e.mail);
        printChar('=',65);
        }
